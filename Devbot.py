...
rooms = r.json()["items"]
for room in rooms:
    print("Type: {}, Title: {}".format(room.get("type", "N/A"), room["title"]))
#######################################################################################
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "b3j8SKRsOtp07tSbMsCaGErR8hRlDfft"
                               }
...
# 11. Complete the code to format the response message.
        responseMessage = "In {} the sun will rise at {} and will set at {} . The day will last {} seconds.".format("In {} the sun will rise at {} and will set at {}. The day will last {} seconds.".format(locationResults, sunriseTime, sunsetTime, dayLengthSeconds))

        print("Sending to Webex Teams: " +responseMessage)

# 12. Complete the code to post the message to the Webex Teams room.            
        HTTPHeaders = { 
                             "Authorization": "Bearer ZWYyZGU5MGQtMzhhZC00ZWY1LWE4MTMtNDI0OGQ3MDZiOThhOGVhNWNjMzAtZmI2_PC75_f1a9c66d-3eff-454d-9c51-a4e0afcd770b",
